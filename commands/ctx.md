...
Začni figlet bannerem s **názvem projektu** (ne „CTX"). Použij slant / block ASCII font, šířka ≤ 60 znaků, umísti do markdown code blocku (``` ... ```). Název zkrať na uppercase bez diakritiky, max 14 znaků.
