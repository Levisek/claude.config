...
| `detect-triggers.js` | UserPromptSubmit | Scanuje user message na trigger words → injectuje token-aware reminder |
| `track-agents.js` | PreToolUse + PostToolUse (Agent) | Auto-doplní `model:` parametr + sleduje běžící agenty pro status panel |
